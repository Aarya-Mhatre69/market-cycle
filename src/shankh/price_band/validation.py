...
def walk_forward_folds(
    ...
    # Convert to int64 nanoseconds for type-safe searchsorted.
    # pd.DatetimeIndex.asi8 always returns int64 regardless of whether the
    # source was numpy.datetime64 or pandas.Timestamp.
