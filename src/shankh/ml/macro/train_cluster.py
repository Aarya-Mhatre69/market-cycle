...
from src.shankh.ml.macro.model import KMeansModel, AgglomerativeModel, IsolationForestModel
from src.shankh.ml.macro.evaluation import evaluate_clustering
...
def train_pipeline() -> Dict[str, Any]:
    ...
    # 4. Train Models
    # 4.1 Correlation Distance Agglomerative Clustering
    ...
    # 4.2 Multi-Factor K-Means Clustering
    scaler = RobustScaler()
    ...
    # 4.3 Forensic Anomaly Detection (Isolation Forest)
