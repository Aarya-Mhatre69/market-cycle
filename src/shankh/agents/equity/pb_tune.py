...
$ python -m shankh.agents.equity.tune --n-trials 30

# Fast execution without HPO (using baseline config parameters):
$ python -m shankh.agents.equity.tune --skip-hpo

# Plot predictions directly from saved Parquet without retraining:
$ python -m shankh.agents.equity.tune --plot-only --ticker INFY.NS
"""
...
from shankh.agents.equity.pb_evaluation import evaluate, save_eval_report, save_predictions
from shankh.agents.equity.pb_features import add_features, get_feature_cols
from shankh.agents.equity.pb_inference import predict_bands
from shankh.agents.equity.pb_model import build_model
from shankh.agents.equity.pb_validation import Fold, walk_forward_folds
