...
HAS_REQUIRED_KEYS = (
    all(os.getenv(k) for k in ["GOOGLE_API_KEY", "MISTRALAI_API_KEY", "CEREBRAS_API_KEY", "TAVILY_API_KEY"])
    and os.getenv("TAVILY_API_KEY") is not None
)

if not HAS_REQUIRED_KEYS:
    pytest.skip(
        "Skipping live integration tests due to missing required API keys in environment variables.",
